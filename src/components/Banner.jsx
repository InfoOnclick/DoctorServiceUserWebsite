...
const Banners=({category})=>{
  ...
  >
    ...
    <div className="flex-1 text-center md:text-left py-8 sm:py-10 md:py-16 lg:py-24 lg:pl-5">
      <div className="text-xl sm:text-2xl md:text-3xl lg:text-5xl font-semibold text-white">
        <p>Book your {category==='doctor'?'Doctor':'Lawyer'}</p>
        <p className="mt-4">Appointment</p>
        <p className="mt-4">Online.</p>
      </div>
      <button
    ...
    {/* -----Right Side (Hidden on Small Screens) ----- */}
    <div className="hidden md:flex md:w-1/2 lg:w-[370px] relative justify-center">
      <img className="w-full max-w-xs md:max-w-sm lg:max-w-md"   src={category === 'doctor' ? assets.appointment_img : "https://th.bing.com/th/id/OIP.hKGZDELu0fyvdWaDP0HUiwHaFj?rs=1&pid=ImgDetMain"} 
  alt="Category Image" />
    </div>
  </div>
  )
