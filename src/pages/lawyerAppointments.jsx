...
const Message=()=>{
          ...
          <div className="flex-1  border border-gray-400 rounded-lg p-8 py-7 mx-2 sm:mx-0 mt-[20px] sm:mt-0 bg-blue-100" id='card'>
            ...
            {!schedul ? (
                  <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                      <Button variant="outline-dark" style={{ borderRadius: '20px' }}  onClick={() =>{ setModalShow(true);console.log("hello")}}>Make Appointment</Button>
 ...
 <MyVerticallyCenteredModal
    ...
    {/* Related Lawyers */}
    <RelatedLawyers docId={docId} speciality={docInfo.speciality}/>
 ...
 >
   ...
   dataFilter.map((item) => (
     ...
     >
      ...
      {!schedul ? (
                  <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                      <Button variant="outline-dark" id="makeAppoint" style={{ borderRadius: '20px' }}  onClick={() => {setModalShow(true);console.log(selectedDate+"  "+selectedTime);}}>Make Appointment</Button>
...
const BookAppointment = () => {
  ...
  setTimeout(() => {
    navigate("/Lawyerschedule"); // Change "/confirmation" to your target route
  }, 200);
   ...
   Enter Your Details
      ...
      <Form onSubmit={handleSubmit}>
            ...
            <Form.Select value={selectedGender} onChange={handleSelectChange}>
                ...
                <div>
                <Button variant="outline-success"  onClick={BookAppointment} style={{alignItems:'center' , borderRadius: '20px',marginTop:'20px',padding:'10px',fontSize:'18px' }}  >Complete Booking</Button>
                </div>          
          </Form>
